...
#### github er project theke settings e jaw--->click: Webhooks--->click: Add webhook--->Payload URL: ngrok er url + /github-webhook/ --->Content type: application/json --->click: Update webhook
#### project er kichu update kore github e push korlei Jenkins Build kora suru korbe.
